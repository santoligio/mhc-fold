...
if __name__ == "__main__":
    parallel_tmalign(
        ...
        output_prefix="/mnt/4TB/giovanna/foldseek/version_02/analysis/tmalign/new_filter2/mhc_all-vs-all",
        pdb_csv="/mnt/4TB/giovanna/foldseek/version_02/analysis/functional_annotation/new_filters/afdb_models_analysis_reviewed.csv",
        num_workers=14,
        chunk_size=10000
    )
