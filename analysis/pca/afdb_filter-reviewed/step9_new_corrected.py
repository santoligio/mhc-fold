...
# Inputs / Outputs
# ------------------------------------------------------------
TMALIGN_DIR = "/mnt/4TB/giovanna/foldseek/version_02/analysis/tmalign/new_filter2"
TMALIGN_PATTERN = "mhc_all-vs-all_part*.csv"

OUTPUT_PCA = "/mnt/4TB/giovanna/foldseek/version_02/analysis/pca/new_filter2/afdb_pca_result_mhc.csv"
