...
# Inputs / Outputs
# ------------------------------------------------------------
TMALIGN_DIR = "/mnt/4TB/giovanna/foldseek/version_02/analysis/tmalign/filtered_afdb_avg"
TMALIGN_PATTERN = "mhc_all-vs-all_part*.csv"

OUTPUT_PCA = "/mnt/4TB/giovanna/foldseek/version_02/analysis/pca/afdb_pca_result_mhc.csv"
